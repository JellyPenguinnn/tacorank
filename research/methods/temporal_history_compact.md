```json
{"schema_version":"1.0","method_id":"temporal_history_compact","family":"temporal_history","status":"candidate","tags":["sequence","history","temporal"],"cost_tier":"medium","prerequisites":["baseline_parity","strict_temporal_cutoff"],"allowed_data":["train_interactions","date","user_id","video_id","author_id","long_view","verified_predictions"],"prohibition_conditions":["unreliable_event_ordering"],"capability_status":"unverified","implementation_targets":["solution/features.py","solution/model.py","solution/train.py","solution/inference.py","solution/candidate.py"],"sources":[]}
```
