...
def build_coding_prompt(
    ...
    *,
    ...
    sections = [
        ...
        "Follow the selected method card's score-path policy. Residual cards preserve the setup-verified FM score and add only a bounded residual. A card tagged parent_replacement requires a direct score path with no FM blend; the approved ExperimentSpec must describe that replacement.",
